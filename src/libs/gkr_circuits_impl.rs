...
use multilinear_poly::MultilinearPoly;
...
mod test {
    ...
    fn it_returns_right_add_i_polys_for_each_layer() {
        ...
        assert_eq!(expected_add_1_poly, add_1_poly.evals);
        assert_eq!(expected_add_2_poly, add_2_poly.evals);
    }
    ...
    fn it_returns_right_mul_i_polys_for_each_layer() {
        ...
        assert_eq!(expected_mul_1_poly, mul_1_poly.evals);
        assert_eq!(expected_mul_2_poly, mul_2_poly.evals);
    }
}
...
// impl Gate {
//     fn new(op: GateOperations, input: Vec<usize>, output_index: usize) -> Self {
//         Self {
//             input,
//             output_index,
//             operation: op,
...
//     fn evaluate_gate(&self, inputs: &[u8]) -> u8 {
//         match self.operation {
//             GateOperations::Add => self.input.iter().map(|&val| inputs[val]).sum(),

//             GateOperations::Mult => self.input.iter().map(|&val| inputs[val]).product(),
//         }
//     }
// }
